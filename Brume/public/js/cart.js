/* ===========================================================
   ...
   =========================================================== */
const CART_KEY = "brume_cart";
const WISH_KEY = "brume_wishlist";
const SHIPPING = 9;          // flat shipping shown in summaries
const FREE_OVER = 150;       // free shipping threshold
const PROMO = { BRUME10: 0.10, ROAST15: 0.15 }; // promo codes -> discount %

/* ---------- storage ---------- */
const LEGACY_CART_KEY = "nova_cart"; // previous key — adopt any cart saved before the rename
function readCart() {
  try {
...
function writeCart(cart) {
  try {
    ...
    console.warn("Brume: couldn't save your cart — storage is unavailable. " +
...
/* ---------- image fallback ----------
   Product photos are hosted remotely (royalty-free) and need a connection.
...
const IMG_FALLBACK =
  ...
  "%3Crect width='100%25' height='100%25' fill='%23ece5d8'/%3E" +
  "%3Cg fill='none' stroke='%23b08d4f' stroke-width='2'%3E" +
  "%3Crect x='150' y='150' width='100' height='80' rx='3'/%3E" +
  "%3Ccircle cx='175' cy='178' r='9'/%3E%3Cpath d='M155 225l28-28 20 18 16-14 26 24'/%3E%3C/g%3E" +
  "%3Ctext x='50%25' y='280' font-family='Georgia, serif' font-size='20' letter-spacing='3' fill='%23b5763e' text-anchor='middle'%3EBRUME%3C/text%3E" +
  "%3C/svg%3E";
  ...
  if (header) {
    ...
    header.innerHTML = `
      <div class="container nav">
        <a class="brand" href="index.html"><span class="dot"></span>Brume</a>
        <nav class="nav-links" id="navLinks">
          <a href="index.html" ${active === "home" ? 'class="active"' : ""}>Home</a>
          <a href="products.html" ${active === "products" ? 'class="active"' : ""}>Shop</a>
          <a href="index.html#features">The Roastery</a>
          <a href="index.html#newsletter">Join the club</a>
        </nav>
        <form class="nav-search" action="products.html" method="get" role="search">
          <span class="ic">${ICONS.search}</span>
          <input type="search" name="q" placeholder="Search the roastery…" aria-label="Search products" value="${q.replace(/"/g, "&quot;")}">
        </form>
        <div class="nav-right">
      ...
      <div class="container">
        <div class="footer-grid">
          <div class="footer-about">
            <a class="brand" href="index.html"><span class="dot"></span>Brume</a>
            <p>A specialty coffee roaster — single-origin beans, signature blends and the gear to brew them, roasted in small batches and shipped fresh.</p>
            <div class="socials">
          ...
          <div>
            <h4>Shop</h4>
            <a href="products.html">All coffee</a>
            <a href="products.html">New roasts</a>
            <a href="products.html">Brewing gear</a>
          </div>
          <div>
            <h4>The Roastery</h4>
            <a href="#">Our story</a>
            <a href="#">How we roast</a>
        ...
        <div class="footer-bottom">
          <span>© 2026 Brume Coffee Roasters. All rights reserved.</span>
          <span>Free shipping over $50 · Roasted fresh to order</span>
        </div>
      </div>`;
  }
