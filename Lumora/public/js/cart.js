...
function writeCart(cart) {
  try {
    ...
    console.warn("Lumora: couldn't save your cart — storage is unavailable. " +
...
const IMG_FALLBACK =
  ...
  "%3Crect width='100%25' height='100%25' fill='%23eef0f6'/%3E" +
  "%3Cg fill='none' stroke='%23b9bed0' stroke-width='2'%3E" +
  "%3Crect x='150' y='150' width='100' height='80' rx='6'/%3E" +
  "%3Ccircle cx='175' cy='178' r='9'/%3E%3Cpath d='M155 225l28-28 20 18 16-14 26 24'/%3E%3C/g%3E" +
  "%3Ctext x='50%25' y='280' font-family='sans-serif' font-size='20' fill='%239aa0b0' text-anchor='middle'%3ELumora%3C/text%3E" +
  "%3C/svg%3E";
      ...
      <div class="container">
        <div class="footer-grid">
          <div class="footer-about">
            <a class="brand" href="index.html"><span class="dot"></span>Lumora</a>
            <p>Thoughtfully designed everyday objects. Built for the way you live, priced to love.</p>
            <div class="socials">
        ...
        <div class="footer-bottom">
          <span>© 2026 Lumora, Inc. All rights reserved.</span>
