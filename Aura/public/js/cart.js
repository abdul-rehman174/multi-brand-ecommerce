...
function writeCart(cart) {
  try {
    ...
    console.warn("Aura: couldn't save your cart — storage is unavailable. " +
...
const IMG_FALLBACK =
  ...
  "%3Ctext x='50%25' y='280' font-family='sans-serif' font-size='20' fill='%239aa0b0' text-anchor='middle'%3EAura%3C/text%3E" +
  "%3C/svg%3E";
