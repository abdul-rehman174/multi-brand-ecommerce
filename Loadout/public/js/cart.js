/* ===========================================================
   ...
   =========================================================== */
const CART_KEY = "loadout_cart";
const WISH_KEY = "loadout_wishlist";
const SHIPPING = 9;          // flat shipping shown in summaries
const FREE_OVER = 150;       // free shipping threshold
const PROMO = { LOADOUT10: 0.10, POWERUP15: 0.15 }; // promo codes -> discount %

/* ---------- storage ---------- */
const LEGACY_CART_KEY = "loadout_cart_old"; // previous key — adopt any cart saved before the rename
function readCart() {
  try {
...
function writeCart(cart) {
  try {
    ...
    console.warn("Loadout: couldn't save your cart — storage is unavailable. " +
...
const IMG_FALLBACK =
  ...
  "%3Crect width='100%25' height='100%25' fill='%23fff1cf'/%3E" +
  "%3Cg fill='none' stroke='%231d1a39' stroke-width='3'%3E" +
  "%3Crect x='150' y='150' width='100' height='80' rx='12'/%3E" +
  "%3Ccircle cx='175' cy='178' r='9'/%3E%3Cpath d='M155 225l28-28 20 18 16-14 26 24'/%3E%3C/g%3E" +
  "%3Ctext x='50%25' y='290' font-family='sans-serif' font-weight='bold' font-size='22' fill='%23f72585' text-anchor='middle' letter-spacing='4'%3ELOADOUT%3C/text%3E" +
  "%3C/svg%3E";
...
function mountChrome(active) {
  ...
  if (header) {
    ...
    const marqueeMsg =
      "Free shipping over $150 ✶ 30-day easy returns ✶ Code LOADOUT10 = 10% off ✶ 2-year warranty ✶ New drops weekly ✶ ";
    header.innerHTML = `
      <div class="marquee" aria-hidden="true">
        <div class="marquee-track"><span>${marqueeMsg}</span><span>${marqueeMsg}</span></div>
      </div>
      <div class="container nav">
        <a class="brand" href="index.html"><span class="dot"></span>Loadout</a>
        <nav class="nav-links" id="navLinks">
          <a href="index.html" ${active === "home" ? 'class="active"' : ""}>Home</a>
          <a href="products.html" ${active === "products" ? 'class="active"' : ""}>Shop</a>
          <a href="index.html#features">The perks</a>
          <a href="index.html#newsletter">Get 10% off</a>
        </nav>
        <form class="nav-search" action="products.html" method="get" role="search">
          <span class="ic">${ICONS.search}</span>
          <input type="search" name="q" placeholder="Search products…" aria-label="Search products" value="${q.replace(/"/g, "&quot;")}">
        </form>
        <div class="nav-right">
      ...
      <div class="container">
        <div class="footer-grid">
          <div class="footer-about">
            <a class="brand" href="index.html"><span class="dot"></span>Loadout</a>
            <p>The happy place for gadgets. Big color, big energy, great specs — and absolutely zero boring.</p>
            <div class="socials">
          ...
          <div>
            <h4>Shop</h4>
            <a href="products.html">All the good stuff</a>
            <a href="products.html">Fresh drops</a>
            <a href="products.html">Deals &amp; steals</a>
          </div>
          <div>
            <h4>Company</h4>
            <a href="#">About Loadout</a>
            <a href="#">Careers</a>
            <a href="#">Press kit</a>
          </div>
          <div>
        ...
        <div class="footer-bottom">
          <span>© 2026 Loadout. Made with too much coffee &amp; confetti.</span>
          <span>Secure checkout · 2-year warranty · 30-day returns</span>
        </div>
      </div>`;
  }
...
function productCardHTML(p) {
  ...
  return `
    <article class="card">
      ...
      <button class="add-btn" data-add="${p.id}">${ICONS.cart} Add to cart</button>
    </article>`;
}
