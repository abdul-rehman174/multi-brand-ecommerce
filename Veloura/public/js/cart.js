...
const PROMO = { VELOURA10: 0.10, ATELIER15: 0.15 }; // promo codes -> discount %
...
function writeCart(cart) {
  try {
    ...
    console.warn("Veloura: couldn't save your cart — storage is unavailable. " +
...
const IMG_FALLBACK =
  ...
  "%3Ctext x='50%25' y='280' font-family='Georgia, serif' font-size='20' letter-spacing='3' fill='%23b08d4f' text-anchor='middle'%3EVELOURA%3C/text%3E" +
  "%3C/svg%3E";
    ...
    header.innerHTML = `
      <div class="container nav">
        ...
        <form class="nav-search" action="products.html" method="get" role="search">
          ...
          <input type="search" name="q" placeholder="Search the boutique…" aria-label="Search products" value="${q.replace(/"/g, "&quot;")}">
        </form>
        <div class="nav-right">
      ...
      <div class="container">
        <div class="footer-grid">
          <div class="footer-about">
            <a class="brand" href="index.html"><span class="dot"></span>Veloura</a>
            <p>A modern boutique of timeless pieces — considered design, honest materials and a quietly elevated wardrobe.</p>
            <div class="socials">
          ...
          <div>
            <h4>Shop</h4>
            <a href="products.html">The collection</a>
            <a href="products.html">New season</a>
            <a href="products.html">The sale</a>
          </div>
          <div>
            <h4>The House</h4>
            <a href="#">Our story</a>
        ...
        <div class="footer-bottom">
          <span>© 2026 Veloura Atelier. All rights reserved.</span>
          <span>Complimentary shipping over $150 · 30-day returns</span>
        </div>
      </div>`;
  }
